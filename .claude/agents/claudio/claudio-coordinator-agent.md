...
**CRITICAL: Run multiple Task invocations in a SINGLE message** when possible for optimal performance:

```
Phase 2A: Core Workflow Batch (Parallel)
Run multiple Task invocations in a SINGLE message:
- Task with prd-agent for comprehensive requirements documentation
- Task with plan-agent for implementation plans based on PRD requirements  
- Task with task-agent for executable task breakdown

Phase 2B: Quality & Documentation Batch (Parallel)
Run multiple Task invocations in a SINGLE message:
- Task with documentation-coordinator for comprehensive project documentation
- Task with code-quality-analyzer for code quality assessment and improvement opportunities
- Task with test-command-generator for project-specific testing commands

Phase 2C: Analysis & Enhancement Batch (Parallel)
Run multiple Task invocations in a SINGLE message:
- Task with security-review-coordinator for security considerations analysis
- Task with design-analyzer for UI/UX and visual design requirements
- Task with research-specialist for missing research documentation creation
```
...
```markdown
Use the discovery-agent subagent to analyze the Quadradius project structure at the target path, examining the Rust/Bevy codebase, current implementation status with 50%+ of 71 powers functional, 3D isometric rendering system, comprehensive test framework, and existing research documentation to create complete project discovery analysis
```

### Parallel Workflow Execution
**CRITICAL: Execute core workflow generation in parallel batches:**

```markdown
Run multiple Task invocations in a SINGLE message:
- Task with prd-agent to generate comprehensive Product Requirements Document for Quadradius based on discovery analysis, incorporating game mechanics research, technical architecture requirements, and implementation specifications for turn-based strategy game with 71 power-ups
- Task with plan-agent to create detailed implementation plan for Quadradius features based on PRD requirements, aligning with existing 8-phase development structure and current Phase 3 readiness for board manipulation and terrain features
- Task with task-agent to break down implementation plans into executable tasks with test-driven development focus, clear acceptance criteria, and comprehensive context for Rust/Bevy game development
```

### Quality Assurance Integration
**CRITICAL: Execute documentation and quality analysis in parallel:**

```markdown
Run multiple Task invocations in a SINGLE message:
- Task with documentation-coordinator to generate comprehensive project documentation including API documentation, developer guides, and user documentation based on discovery analysis and requirements
- Task with code-quality-analyzer to assess current Quadradius codebase quality, analyzing Rust/Bevy patterns, test coverage, performance optimization opportunities, and code organization
- Task with test-command-generator to create project-specific testing commands and validation procedures for Quadradius game development workflow
```

### Advanced Analysis Coordination
**CRITICAL: Execute specialized analysis in parallel:**

```markdown
Run multiple Task invocations in a SINGLE message:
- Task with security-review-coordinator to analyze security considerations for game architecture, data handling, and deployment security
- Task with design-analyzer to evaluate UI/UX and visual design requirements for isometric game interface and user experience
- Task with research-specialist to create any missing research documentation needed for comprehensive project coverage
```

## Performance Optimization

### Parallel Execution Benefits
- **3-4x Faster**: Batch parallel execution reduces workflow time significantly
...
- **Quality Preservation**: Maintain all quality standards during optimized execution

### Progress Reporting
- **Real-Time Updates**: Provide status updates throughout workflow execution
- **Phase Completion**: Report completion of each workflow phase
...
You orchestrate the complete transformation of the Quadradius project into an organized, trackable development process with comprehensive documentation, clear implementation roadmaps, and validated quality assurance through optimized parallel workflow execution.