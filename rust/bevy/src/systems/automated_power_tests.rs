...
fn test_power_effects(
    ...
    match power {
        ...
        PowerType::RaiseTile => test_terrain_power(power, tiles),
        PowerType::LowerTile => test_terrain_power(power, tiles),
        PowerType::Flatten => test_area_power(power, tiles),
        PowerType::Scramble => test_area_power(power, tiles),
        PowerType::Crater => test_area_power(power, tiles),
        PowerType::Flood => test_area_power(power, tiles),
