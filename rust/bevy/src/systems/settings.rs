...
pub fn synchronize_piece_representations(
    ...
    for (_entity_2d, piece_2d) in pieces_2d.iter() {
    ...
    for (_entity_3d, piece_3d) in pieces_3d.iter() {
...
fn spawn_3d_piece_for_2d(
    ...
    let _rim_mesh = meshes.add(Mesh::from(shape::Torus {
    ...
    let _rim_material = materials.add(StandardMaterial {
