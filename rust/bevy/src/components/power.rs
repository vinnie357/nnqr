...
// For acid holes that permanently damage tiles
#[derive(Component)]
pub struct AcidHole;
...
impl PowerType {
    pub fn random() -> Self {
        ...
        match roll {
            ...
            91..92 => PowerType::Pit,
            92..93 => PowerType::Terraform,

            // Individual tile terrain powers (2% chance)
            93..94 => PowerType::RaiseTile,
            94..95 => PowerType::LowerTile,
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            // Individual tile terrain powers
            PowerType::RaiseTile => "Raise Tile",
            PowerType::LowerTile => "Lower Tile",
            PowerType::Flatten => "Flatten",
            PowerType::Scramble => "Scramble",
            PowerType::Crater => "Crater",
            PowerType::Flood => "Flood",
    ...
    pub fn description(&self) -> &'static str {
        match self {
            ...
            // Individual tile terrain powers
            PowerType::RaiseTile => "Raise a single tile by 1-3 levels",
            PowerType::LowerTile => "Lower a single tile by 1-3 levels",
            PowerType::Flatten => "Set all tiles in 3x3 area to uniform height",
            PowerType::Scramble => "Randomize tile heights in 3x3 area",
            PowerType::Crater => "Create a large depression in 3x3 area",
            PowerType::Flood => "Fill low areas with water blocking movement",
    ...
    pub fn power_category(&self) -> PowerCategory {
        match self {
            ...
            | PowerType::Scramble
            | PowerType::Crater
            | PowerType::Flood => PowerCategory::Terrain,
