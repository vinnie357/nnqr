...
fn test_visual_alignment_practical() {
    ...
    app.world.run_system_once(|mut commands: Commands| {
        ...
        let tile_x =
            (test_board_pos.0 as f32 - BOARD_WIDTH as f32 / 2.0 + 0.5) * enhanced_tile_size;
        let tile_y =
            (test_board_pos.1 as f32 - BOARD_HEIGHT as f32 / 2.0 + 0.5) * enhanced_tile_size;
            ...
            .spawn((
                ...
                SpriteBundle {
                    ...
                    transform: Transform::from_xyz(
                        indicator_world_pos.x,
                        indicator_world_pos.y,
                        2.0,
                    ),
                    ..default()
                },
        ...
        println!(
            "📦 Created entities at board position ({}, {}):",
            test_board_pos.0, test_board_pos.1
        );
    ...
    app.world.run_system_once(
        ...
        >| {
            ...
            println!(
                "  Tile ↔ Indicator: {} (distance: {:.3})",
                if tile_indicator_match {
                    "✅ MATCH"
                } else {
                    "❌ MISMATCH"
                },
            ...
            println!(
                "  Piece ↔ Indicator: {} (distance: {:.3})",
                if piece_indicator_match {
                    "✅ MATCH"
                } else {
                    "❌ MISMATCH"
                },
