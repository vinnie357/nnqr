...
pub fn debug_spawn_powers(keyboard: Res<Input<KeyCode>>, mut game_state: ResMut<GameState>) {
...
pub fn debug_display_powers(game_state: Res<GameState>, mut last_display: Local<String>) {
