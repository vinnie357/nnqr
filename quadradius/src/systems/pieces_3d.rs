...
use crate::systems::board_3d::BoardTile3D;
...
fn spawn_piece_3d(
    ...
    let (base_color, accent_color) = match player {
        Player::Player1 => (QuadradiusTheme::TEAM_1_PRIMARY, QuadradiusTheme::TEAM_1_ACCENT),
        Player::Player2 => (QuadradiusTheme::TEAM_2_PRIMARY, QuadradiusTheme::TEAM_2_ACCENT),
    };
